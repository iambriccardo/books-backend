...
var getCoordinatesFromAddress = function (address) { return __awaiter(void 0, void 0, void 0, function () {
    var url, response, jsonBody, results, location_1, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                url = "https://maps.googleapis.com/maps/api/geocode/json?key=" + environment_1.GCP_API_KEY + "&address=" + address;
            ...
            case 2:
                error_1 = _a.sent();
                throw new base_1.GCPError(error_1);
