...
var signupUseCase = function (body) {
                ...
                case 1:
                    ...
                    if (foundUser) {
                        if (foundUser.username === body.username)
                            throw new base_1.UserAlreadyExistsError(foundUser.username);
                        else if (foundUser.email === body.email)
                            throw new base_1.EmailAlreadyExistsError(foundUser.email);
                    }
                    return [4 /*yield*/, new user_1.UserModel(body).save()];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
