...
mocha_1.describe('createTransactionUseCase', function () {
    ...
    it('should create a transaction if the book is existing and not sold', function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        book = _a.sent();
                        useCase = create_transaction_1.createTransactionUseCase(book.bookId);
    ...
    it('should throw an error if the transaction is for a sold book', function () {
        return __awaiter(this, void 0, void 0, function () {
            var book, useCase;
            return __generator(this, function (_a) {
                switch (_a.label) {
