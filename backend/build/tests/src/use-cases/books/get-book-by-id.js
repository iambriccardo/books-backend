...
var get_book_by_id_1 = require("../../../../src/use-cases/books/get-book-by-id");
chai_1.use(chai_as_promised_1.default);
mocha_1.describe('getBookByIdUseCase', function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        book = _b.sent();
                        useCase = get_book_by_id_1.getBookByIdUseCase(book.bookId);
    ...
    it('should throw an error if the book is not existing', function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        useCase = get_book_by_id_1.getBookByIdUseCase('5081519d8c2f4a0a88aa8216');
