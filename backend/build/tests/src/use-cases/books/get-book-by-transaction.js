...
var get_book_by_transaction_1 = require("../../../../src/use-cases/books/get-book-by-transaction");
chai_1.use(chai_as_promised_1.default);
mocha_1.describe('getBookByTransactionUseCase', function () {
    ...
    it('should returns the book linked to the transaction', function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        transaction = _b.sent();
                        useCase = get_book_by_transaction_1.getBookByTransactionUseCase(transaction.transactionId);
    ...
    it('should throw an error if the transaction is not existing', function () {
        return __awaiter(this, void 0, void 0, function () {
            var useCase;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        useCase = get_book_by_transaction_1.getBookByTransactionUseCase('');
    ...
    it('should throw an error if the book is not existing', function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        transaction = _a.sent();
                        return [4 /*yield*/, book_1.BookModel.deleteOne({ bookId: book.bookId })];
                    case 3:
                        _a.sent();
                        useCase = get_book_by_transaction_1.getBookByTransactionUseCase(transaction.transactionId);
                        return [4 /*yield*/, chai_1.expect(useCase()).to.be.rejected];
