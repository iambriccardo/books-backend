...
var get_selling_books_1 = require("../../../../src/use-cases/books/get-selling-books");
var fixtures_1 = require("../../../helpers/fixtures");
chai_1.use(chai_as_promised_1.default);
mocha_1.describe('getSellingBooksUseCase', function () {
    ...
    it('should return the books the user is selling if it is selling any', function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.sent();
                        useCase = get_selling_books_1.getSellingBooksUseCase('608e519d8c2f4a0a88aa8216');
    ...
    it('should return nothing if the user is not selling any books', function () {
        return __awaiter(this, void 0, void 0, function () {
            var useCase, _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
