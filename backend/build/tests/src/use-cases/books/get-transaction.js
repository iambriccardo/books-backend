...
var get_transaction_1 = require("../../../../src/use-cases/books/get-transaction");
chai_1.use(chai_as_promised_1.default);
mocha_1.describe('getTransactionUseCase', function () {
    ...
    it('should get the transaction if it exists', function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        _b.sent();
                        useCase = get_transaction_1.getTransactionUseCase(book.bookId);
                        _a = chai_1.expect;
    ...
    it('should throw an error if the transaction does not exist', function () {
        return __awaiter(this, void 0, void 0, function () {
            var book, useCase;
