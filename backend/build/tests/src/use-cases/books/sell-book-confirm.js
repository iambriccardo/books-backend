...
var sell_book_confirm_1 = require("../../../../src/use-cases/books/sell-book-confirm");
...
mocha_1.describe('sellBookConfirmUseCase', function () {
    ...
    it('should mark the book as sold if all the params are correct', function () {
        return __awaiter(this, void 0, void 0, function () {
            var book, transaction, useCase, _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        transaction = _b.sent();
                        useCase = sell_book_confirm_1.sellBookConfirmUseCase('708e519d8c2f4a0a88aa8216', transaction.transactionId);
                        return [4 /*yield*/, chai_1.expect(useCase()).to.not.be.rejected];
                    case 3:
                        _b.sent();
                        _a = chai_1.expect;
                        return [4 /*yield*/, book_1.BookModel.findOne({
                                bookId: book.bookId,
                                buyer: { $exists: true },
    ...
    it('should throw an error if the transaction is invalid', function () {
        return __awaiter(this, void 0, void 0, function () {
            var useCase;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        useCase = sell_book_confirm_1.sellBookConfirmUseCase('708e519d8c2f4a0a88aa8216', '');
    ...
    it('should throw an error if the book has been removed', function () {
        return __awaiter(this, void 0, void 0, function () {
            var book, transaction, useCase;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, sell_book_1.sellBookUseCase(fixtures_1.sellBookBodyFixture({
                            seller: '608e519d8c2f4a0a88aa8216',
                    ...
                    case 2:
                        transaction = _a.sent();
                        return [4 /*yield*/, remove_book_1.removeBookUseCase('608e519d8c2f4a0a88aa8216', book.bookId)()];
                    case 3:
                        _a.sent();
                        useCase = sell_book_confirm_1.sellBookConfirmUseCase('608e519d8c2f4a0a88aa8216', transaction.transactionId);
                        return [4 /*yield*/, chai_1.expect(useCase()).to.be.rejected];
                    case 4:
                        _a.sent();
                        return [2 /*return*/];
    ...
    it('should throw an error if the seller and the buyer are the same', function () {
        return __awaiter(this, void 0, void 0, function () {
            var book, transaction, useCase;
            return __generator(this, function (_a) {
                switch (_a.label) {
