...
var sell_book_link_1 = require("../../../../src/use-cases/books/sell-book-link");
chai_1.use(chai_as_promised_1.default);
mocha_1.describe('sellBookLink', function () {
    before(mongoose_1.initTestMongoose);
    after(mongoose_1.destroyTestMongoose(transaction_1.TransactionModel, book_1.BookModel));
    afterEach(mongoose_1.deleteCollections(transaction_1.TransactionModel, book_1.BookModel));
    var baseUrl = 'localhost:3000/confirm';
    it('should return the sell confirmation link if the transaction is valid', function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        transaction = _b.sent();
                        useCase = sell_book_link_1.sellBookLinkUseCase(baseUrl, transaction);
                        _a = chai_1.expect;
    ...
    it('should throw an error if the transaction is invalid', function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        useCase = sell_book_link_1.sellBookLinkUseCase(baseUrl, {
                            transactionId: '',
                            bookId: '',
                        });
