...
mocha_1.describe('sellBookUseCase', function () {
    ...
    it('should insert the book into the database if the book is valid and has optional parameters', function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        useCase = sell_book_1.sellBookUseCase(body);
                    ...
                    case 2:
                        _b.sent();
                        _a = chai_1.expect;
                        return [4 /*yield*/, book_1.BookModel.findOne({ isbn: '978-1-56619-909-4' })];
                    case 3:
    ...
    it("should insert the book into the database if the book is valid and doesn't have optional parameters", function () {
        return __awaiter(this, void 0, void 0, function () {
            var body, useCase, _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
    ...
    it('should throw an error if the book is invalid', function () {
        return __awaiter(this, void 0, void 0, function () {
            var body, useCase;
